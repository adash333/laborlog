...
公開URL:**https://r.5micro.net/**(スマートフォンで開いて「ホーム画面に追加」するとアプリとして使えます)
...
- 有給休暇関連の記録(取得妨害等のチェック・取得日数)とスコア反映
- レッドフラッグ(月80h/100h、2〜6か月平均80h超、月45h超が年7か月以上、14連勤、暴力・重大な性的言動・脅迫等)を総合点と独立に判定
...
- アプリロック(PIN)
- 公開前の専門家レビュー(スコア閾値・警告文・相談先ルーティング)
